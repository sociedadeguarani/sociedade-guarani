...
export default function Home() {
  ...
  const menuAtual = useMemo(() => {
    const encontrado = menus.find((item) => item.rota === pathname);
    return encontrado?.nome || "Sócios";
  }, [pathname]);
  ...
  async function salvarSocio() {
    ...
    const dadosBase = {
      ...
      conta_bancaria_id: form.tipo_pagamento === "debito_em_conta" ? (form.conta_bancaria_id || null) : null,
