...
const PERFIL_VISUAL: Record<string, { label: string; desc: string; icon: typeof Crown; bg: string; color: string }> = {
  administrador: { label: "Administrador Master", desc: "Acesso total e único perfil que pode criar usuários.", icon: Crown, bg: "#E8F3EE", color: "#005A3C" },
  administrador_normal: { label: "Administrador Normal", desc: "Administração fiscal, financeira e operacional.", icon: Crown, bg: "#EEF7F2", color: "#005A3C" },
